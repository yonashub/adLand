...
/********YONAS***** create a standard viewport **********/
//viewportSize = {width: 1280, height: 1024}
page.viewportSize = { width: 1280, height: 1024 };
/*** end of create viewport *****************************/
...
/******YONAS SCROLL PAGE DOWN AND UP TO LET THE ASSYNC JAVASCRIPT RUN AND RENDER THE PAGE   ***/

	//page.evaluate(function(){
           	var page_bottom=document.body.scrollHeight;
	   	page.scrollPosition = {top: page_bottom,left: 0 };
	  // 	page.scrollPosition = {top: 10,left: 10 };
	 	page.scrollPosition = {top: page_bottom+10,left: 0 };
		page.scrollPosition = {top: 0,left: 0 };
	//}	


/***** END OF SCROLL PAGE DOWN AND UP    ***/
...
if (g_opts.capture_screen) {
    ...
    if (undefined === delay_sec) {
		...
		var page_bottom=document.body.scrollHeight;
                page.scrollPosition = {top: page_bottom,left: 0 };
          	//page.scrollPosition = {top: 10,left: 10 };
                page.scrollPosition = {top: page_bottom+i+10,left: 0 };
                page.scrollPosition = {top: 0,left: 0 };
        	//} 
		}    
		//page.scrollPosition = {top: 0,left: 0 };
